...
namespace Umbra.Content.GUI
{
	...
	public class Tooltip : SmartUIState, ILoadable
	{
		...
		public override void Draw(SpriteBatch spriteBatch)
		{
			...
			float tipWidth = ChatManager.GetStringSize(font, tooltip, Vector2.One * 0.8f, 300).X;
			...
			if (tooltip != null && tooltip.Length > 0)
				ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, font, tooltip, pos, 0, Vector2.Zero, Vector2.One * 0.8f, out int hov2, 300);
		}
