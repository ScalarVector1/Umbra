...
namespace Umbra.Core.PassiveTreeSystem
{
	internal class TreeSystem : ModSystem
	{
		...
		public static void Export()
		{
			...
			string name = $"CustomUmbraTree_{Main.worldName}_{DateTime.Now:MM_dd_yy-HH_mm_ss_fff}.json";
		...
		{
			string defaultCustom = ModContent.GetInstance<CustomTreeConfig>().customTreeJson;
